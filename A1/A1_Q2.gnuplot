...
plot "A1_Q2_data.dat" using 2:4 with lines linewidth 2 title "Continuous (RK4)", \
     "A1_Q2_data.dat" using 6:8 with points pointtype 7 pointsize 0.35 \
...
plot "A1_Q2_data.dat" using 1:2 with lines linewidth 2 title "x (RK4)", \
     ...
     "A1_Q2_data.dat" using 1:6 with points pointtype 5 pointsize 0.3 \
     title "x (discrete)", \
     "A1_Q2_data.dat" using 1:8 with points pointtype 7 pointsize 0.3 \
     title "y (discrete)"
...
plot "A1_Q2_data.dat" using 1:3 with lines linewidth 2 title "vx (RK4)", \
     ...
     "A1_Q2_data.dat" using 1:7 with points pointtype 5 pointsize 0.3 \
     title "vx (discrete)", \
     "A1_Q2_data.dat" using 1:9 with points pointtype 7 pointsize 0.3 \
     title "vy (discrete)"
